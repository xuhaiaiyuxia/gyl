var menuitem = {
	...
	/***********************************************************************************/
		...
		{id:'7',name:'商品档案',pid:'2',url:'productAction_showAllProduct.action',target:'right'},
		{id:'8',name:'仓库',pid:'2',url:'repositoryAction_showRepository.action',target:'right'},
		{id:'9',name:'客户',pid:'2',url:'customerAction_showCustomer.action',target:'right'},
		{id:'10',name:'供应商',pid:'2',url:'supplierAction_showSupplier.action',target:'right'},
		{id:'11',name:'权限管理',pid:'1'},
		{id:'111',name:'角色配置',pid:'11',url:'userAction_showUsers.action',target:'right'},
		{id:'112',name:'权限配置',pid:'11',url:'role2Action_showRoles.action',target:'right'},
	/***********************************************************************************/
		 /**
		   *  业务
		   */
	...
	/***********************************************************************************/
		...
		{id:'1511',name:'查询',pid:'151',url:'repositoryAction_showRepository.action',target:'right'},
